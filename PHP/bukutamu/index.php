...
<p>Email (opsional) &nbsp;&nbsp;&nbsp;&nbsp;:
<input placeholder="@gmail.com" type="text" name="email"/>
</p>
<p>Website (opsional) :
<input type="text" placeholder="http://www. .id" name="website"/>
</p>
<p>Pesan:
<textarea placeholder="Ketikan pesan anda" cols="90" rows="10" name="pesan" required></textarea>
</p>
