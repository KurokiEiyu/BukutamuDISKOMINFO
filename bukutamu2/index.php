...
<html>
<head>
	<title>Buku Tamu Diskominfo Kota Sukabumi</title>
...
<center>
	...
	<header>
		...
		<p class="deskripsi">Pusat Layanan Informasi dan Pusat Pelaporan Pengaduan Layanan Publik</p>
	</header>
	...
	<div class="wrap">
		...
		<aside class="sidebar">
			<div class="widget">
				...
				<p>Di Halaman Buku Tamu Dinas Komunikasi dan Informatika.</p>
			</div>
			<div class="widget">
				<h2>Alamat</h2>
				<p>Jl. Syamsudin. SH No.25, Cikole, Kec. Cikole, Kota Sukabumi, Jawa Barat 43111. <a target="_blank" href="http://diskominfo.sukabumikota.go.id">http://diskominfo.sukabumikota.go.id</a>.</p>
			</div>
		</aside>
